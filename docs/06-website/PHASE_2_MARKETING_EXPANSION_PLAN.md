...
**Audience:** Patients, family members, caregivers, clinicians, rehabilitation partners, and future distribution partners
...
## 2. Recommended Phase 2 information architecture

The current top navigation is useful for discovery, but feature content should become easier to scan and compare. Add a dedicated **Features** destination while preserving pathway and education routes.
...
| `/features/progress` | Explain meaningful progress, goals, milestones, trends, and consistency | P0 |
| `/features/learn` | Show articles, guides, videos, FAQs, sources, and clinical review | P1 |
| `/features/health-connections` | Explain Apple Health/Health Connect, source labels, permissions, and privacy | P1 |
...
## 3. Feature-page content model

Every feature page should answer five questions in order: **What is this? Who is it for? What does it help someone do? What does it look like? What should the visitor do next?** This structure is easier for patients and family members than a technical feature inventory.

| Page module | Required content | UX treatment |
| --- | --- | --- |
...
| Conversion | Early access, newsletter, or real app-store CTA | CTA language should match the product’s actual availability |
...
**Primary message:** “Guidance that helps you practise with confidence.” Show exercise categories, detail screen, video/caption/audio support, safety information, timer/rep flow, feedback, and completion summary. Keep the page focused on clarity and support rather than performance or athletic achievement.

**Recommended sections:** find an exercise, understand the movement, practise with guidance, record how it felt, and see it contribute to the recovery plan.

### 3.3 Wellbeing

**Primary message:** “Recovery is more than physical exercise.” Present mood, sleep, energy, fatigue, nutrition education, mindfulness, and routine support as gentle context around rehabilitation. Avoid claiming that the app treats mental-health or medical conditions.

**Recommended sections:** daily check-in, sleep and energy, nutrition education, breathing/mindfulness, and non-judgmental reminders.

### 3.4 Progress

**Primary message:** “See how far you’ve come.” Prioritize meaningful outcomes, goals, milestones, consistency, and understandable trends. Avoid raw metric overload and avoid promising specific clinical outcomes.

**Recommended sections:** personal goal, completed sessions, consistency, milestones, journey timeline, and health data as secondary context.

### 3.5 Learn

**Primary message:** “Understand your recovery in plain language.” Treat the Learn page as both a product feature page and a content gateway. Show condition guides, exercise education, explainers, videos, FAQs, reading time, clinical reviewer, review date, sources, and related content.

**Recommended sections:** search, featured pathway guides, reviewed-content trust marker, popular questions, and newsletter signup.
...
Use a simple three-level model only if the product capabilities and support obligations justify it. Safety-critical education and basic safety information should never be hidden behind a paywall.
...
### 4.3 Pre-launch pricing experience
...
### 4.4 Pricing experiments after validation

Once the app has real usage and support data, run controlled experiments rather than choosing pricing only by competitor comparison. Test whether visitors respond better to monthly, annual, family-supported, partner-code, or one-time introductory access. Measure completed onboarding, first recovery activity, 30-day retention, cancellation reasons, support load, newsletter-to-activation conversion, and the percentage of users who reach meaningful progress moments.

Pricing experiments must be reviewed for fairness and accessibility. Do not use dark patterns, forced trials, hidden renewal terms, guilt-based messaging, or paywalls that interrupt a safety-critical workflow.

## 5. Page-level conversion system

Each feature page should have a clear relationship to the three main visitor states.
...
The website should not repeat “Start Your Journey” everywhere. Use intent-specific labels such as **Explore Cardiac Recovery**, **See Today’s Recovery**, **Read the Stroke Recovery Guide**, **Compare Access**, and **Join Early Access**.

## 6. SEO and content expansion

Phase 2 should turn the existing blog and pathway routes into a connected recovery knowledge system. Every feature page should link to relevant guides, and every guide should link back to a relevant feature and pathway page. This supports the repository’s stated goal of becoming a Recovery Knowledge Platform rather than a simple app landing page.[2]

Priority content clusters should include cardiac rehabilitation basics, stroke and neuro recovery, kidney-related fatigue and movement, liver-related strength and mobility, daily check-ins, sleep and wellbeing during recovery, and questions from family members supporting someone at home. Clinical content should carry author, reviewer, review date, version, sources, and next review date where appropriate.[3]

## 7. Design and implementation system

Create reusable page-level primitives before building every route independently. Recommended components include `FeatureHero`, `ProductWalkthrough`, `ScreenshotFrame`, `TrustModule`, `SafetyBoundary`, `PathwayLinkGrid`, `RelatedContent`, `PricingCard`, `FeatureComparison`, `FAQList`, and `AccessStatusBanner`.

Use one data-driven configuration for features and pricing so copy, screenshots, pathway relationships, metadata, and CTAs remain consistent. Feature pages should use the existing warm green/cream system, but vary composition through editorial panels, large screenshot frames, timelines, diagrams, and human imagery rather than introducing another set of repetitive white cards.

## 8. Phase 2 delivery sequence

| Sprint | Deliverable | Exit criteria |
| --- | --- | --- |
| Sprint 1 | Feature IA, content model, pricing principles, and page wireframes | Routes, user intents, CTA hierarchy, and safety boundaries approved |
| Sprint 2 | `/features` overview plus Recovery Plans and Exercises pages | Responsive pages with real or clearly labelled prototype visuals |
| Sprint 3 | Wellbeing and Progress pages | Meaningful-outcome messaging, accessible UI examples, related content links |
| Sprint 4 | Learn, Privacy, Accessibility, and Health Connections pages | Trust metadata, permission explanations, and cross-linking complete |
| Sprint 5 | `/pricing` access page and comparison experience | Pre-launch status clear, no invented prices or availability claims |
| Sprint 6 | Analytics, SEO, accessibility QA, and user testing | Core events measured, keyboard/screen-reader checks passed, user tasks validated |
...
Phase 2 is complete when the website has a coherent feature-page system, each major capability has a dedicated explanation, pricing/access status is transparent, safety and privacy boundaries are visible, every page has a meaningful next action, the content graph links guides to features and pathways, all screenshots reflect real or clearly labelled prototype states, the newsletter and early-access flow are production-ready, and the site passes responsive, accessibility, SEO, and build validation.
